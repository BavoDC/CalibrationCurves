...
## Default approach {#ClusCalDef}

By default, the `valProbCluster` function employs the 2MA-C method for prediction intervals and overall curve and the MIX-C approach for the center specific curves as recommended in the publication @ClusteredCalibration.

```{r}
res_def <- valProbCluster(
  p = valClusterData$preds, y = valClusterData$y, cluster = valClusterData$center,
  pl = TRUE,
  approach = "default", cluster_curves =T
)
res_def
```
