...
<br clear="right">
In this document, we give you a brief overview of the basic functionality of the `CalibrationCurves` package. We advise you to also consult the help-pages of the functions to get an exhaustive overview of the functionality. 
...
\begin{align*}
  \text{logit}(P({}_{*} y_i = 1| {}_{*} \widehat{\pi}_i)) &= \alpha + \zeta {}_{*} \text{logit}({}_{*} \widehat{\pi}_i)
  (\#eq:logcal)
\end{align*}
...
In my recent paper, I propose an extension of the logistic calibration framework to distributions that belong to the exponential family with probability density function (pdf)
\begin{align*}
...
\begin{align*}
\text{logit}(E[{}_{*} y_i | {}_{*} \widehat{\pi}_i]) = \alpha + \zeta {}_{*} \text{logit}({}_{*} \widehat{\pi}_i)
\end{align*}
