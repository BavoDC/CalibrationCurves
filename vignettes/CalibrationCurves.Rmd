...
# Unified `calibrationCurve()` interface

To simplify the workflow, the `calibrationCurve()` function automatically detects the model class and dispatches to the appropriate calibration function:
